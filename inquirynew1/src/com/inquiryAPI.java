...
/**
 * Servlet implementation class inquirysAPI
 */
...
public class inquiryAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = inquiryObj.insertinquiry(request.getParameter("inquiryCode"), 
				 						   request.getParameter("inquiryName"), 
				 						   request.getParameter("inquiryPrice"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = inquiryObj.updateinquiry(paras.get("hidinquiryIDSave").toString(), 
				 							paras.get("inquiryCode").toString(), 
				 							paras.get("inquiryName").toString(), 
				 							paras.get("inquiryPrice").toString(), 
